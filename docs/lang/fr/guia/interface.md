...
![Texte alternatif](../../../imagens/barra_opcoes.png)
...
![Texte alternatif](../../../imagens/mudanca_visao.png) ***Changer de Vue***
...
![Texte alternatif](../../../imagens/voltar_avancar.png) ***Retour/Suivant***

Il vous permet de naviguer vers un enregistrement précis, en avant ou en arrière, quelle que soit la vue active.

![Texte alternatif](../../../imagens/novo.png) ***Nouvel enregistrement***

Elle permet l'insertion de nouveaux enregistrements sur la plateforme.

![Texte alternatif](../../../imagens/salvar.png) ***Enregistrer les modifications de l'enregistrement***
...
![Texte alternatif](../../../imagens/anular.png) ***Annuler la modification***
...
![Texte alternatif](../../../imagens/gerir_anexo.png) ***Gérer les pièces jointes***

Permet de joindre des documents à une entité spécifique.

![Texte alternatif](../../../imagens/apontamento.png) ***Note*** 
...
![Texte alternatif](../../../imagens/email.png) ***E-mail***

Cela nous permet d'envoyer un courriel à l'inscription sélectionnée.

![Texte alternatif](../../../imagens/barra_pesquisa.png) ***barre de recherche***
