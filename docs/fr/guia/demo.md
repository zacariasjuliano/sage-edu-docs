...
Nous hébergeons un serveur de démonstration public où vous pouvez tester SAGE Education avec différents profils d'accès :

| **Profile**     |**Utilisateurs**|
|-----------------|----------------|
| Etudiants       | student        |
| Enseignants     | teacher        |
| Sécrétariat     | secretary      |
| Direction       | direction      |
...
Si vous rencontrez des erreurs ou avez besoin d'assistance technique, veuillez nous contacter via les canaux ci-dessous :
